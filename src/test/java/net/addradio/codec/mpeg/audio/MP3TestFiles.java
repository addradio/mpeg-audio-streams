...
public class MP3TestFiles {
    ...
    /** {@link String} MP3_TEST_FILE_DIRECTORY. */
    public static final String MP3_TEST_FILE_DIRECTORY = "src" + File.separator + "test" + File.separator //$NON-NLS-1$ //$NON-NLS-2$
            + "mp3"; //$NON-NLS-1$

    /** {@link String} FILE_NAME_1000HZ_MP3 */
    public static final String FILE_NAME_1000HZ_MP3 = MP3_TEST_FILE_DIRECTORY + File.separator + "1000Hz.mp3"; //$NON-NLS-1$

    /** {@link String} FILE_NAME_440HZ_MP3 */
    public static final String FILE_NAME_440HZ_MP3 = MP3_TEST_FILE_DIRECTORY + File.separator + "440Hz.mp3"; //$NON-NLS-1$

    /** {@link String} FILE_NAME_ORGAN_MP3 */
    public static final String FILE_NAME_ORGAN_MP3 = MP3_TEST_FILE_DIRECTORY + File.separator + "organ.mp3"; //$NON-NLS-1$

    /** {@link String} FILE_NAME_PIANO_MP3 */
    public static final String FILE_NAME_PIANO_MP3 = MP3_TEST_FILE_DIRECTORY + File.separator + "piano.mp3"; //$NON-NLS-1$
